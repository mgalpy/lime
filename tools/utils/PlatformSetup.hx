...
class PlatformSetup {
	...
	public static function setupAndroid ():Void {
		...
		//override default
		var answer = YES; //CLIHelper.ask ("Download and install the Android SDK?");
		...
		if (answer == YES || answer == ALWAYS) {
			...
			//override default - added new line here
			LogHelper.println ("Path: " + path);
			...
			if (PlatformHelper.hostPlatform == Platform.WINDOWS) {
				...
				//override default - do not install - will install outside this process
		...
		if (answer == ALWAYS) {
			...
			//override default
			answer = YES;//CLIHelper.ask ("Download and install Apache Ant?");
		...
		if (PlatformHelper.hostPlatform != Platform.MAC) {
			...
			if (answer == YES || answer == ALWAYS) {
				...
				//override default
				var secondAnswer = NO; //CLIHelper.ask ("Would you like to go there now?");
